      ...
      <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-2">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold">
            A dedicated Software development company based on Mek'ele, Ethiopia
          </h1>
          <p className="text-sm">
            our company possess an impressive arsenal of skills in HTML, CSS,
            JavaScript, Reactjs, Nextjs, Redux, Tailwind and flutter. we design
            and maintain responsive websites that offer a smooth user
            experience. our expertise lies in crafting dynamic, engaging
